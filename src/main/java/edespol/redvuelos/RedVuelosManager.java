...
public class RedVuelosManager {
    ...
    public List<String> buscarRutaDFS(String origen, String destino) {
        ...
        System.out.println(" Buscando ruta DFS (Recursivo) de " + origen + " a " + destino);
        
        List<String> ruta = grafo.buscarRutaDFS(origen, destino);
        
        if (ruta != null) {
            System.out.println("Ruta DFS (Recursivo) encontrada: " + String.join(" → ", ruta));
        } else {
            System.out.println(" No se encontró ruta DFS (Recursivo) entre " + origen + " y " + destino);
        }
    ...
    /**
     * Busca una ruta usando DFS con pila (iterativo)
     */
    public List<String> buscarRutaDFSPila(String origen, String destino) {
        ...
        System.out.println(" Buscando ruta DFS (Pila) de " + origen + " a " + destino);
        
        List<String> ruta = grafo.buscarRutaDFSPila(origen, destino);
        
        if (ruta != null) {
            System.out.println("Ruta DFS (Pila) encontrada: " + String.join(" → ", ruta));
        } else {
            System.out.println(" No se encontró ruta DFS (Pila) entre " + origen + " y " + destino);
        }
