...
public class RutaManager {
    ...
    public void mostrarFormularioBuscarRutaOptima() {
        ...
        btnBuscar.setOnAction(e -> {
            try {
                ...
                GrafoAeropuertos.RutaOptima ruta = manager.encontrarRutaOptima(origen, destino, cmbMetrica.getValue());
    ...
    /**
     * Muestra el formulario para buscar ruta con DFS (Recursivo)
     */
    public void mostrarFormularioBuscarRutaDFS() {
        Stage dialog = new Stage();
        dialog.initModality(Modality.APPLICATION_MODAL);
        dialog.initOwner(ownerStage);
        dialog.setTitle("Buscar Ruta DFS (Recursivo)");
        ...
        Button btnBuscar = new Button("Buscar Ruta DFS (Recursivo)");
        TextArea txtResultado = new TextArea();
        txtResultado.setEditable(false);
        txtResultado.setPrefSize(400, 200);
        ...
        btnBuscar.setOnAction(e -> {
            try {
                ...
                if (ruta != null) {
                    StringBuilder resultado = new StringBuilder();
                    resultado.append("RUTA DFS (RECURSIVO) ENCONTRADA\n");
                    resultado.append("================================\n");
                    resultado.append("Origen: ").append(origen).append("\n");
                    resultado.append("Destino: ").append(destino).append("\n");
                    resultado.append("Número de escalas: ").append(ruta.size() - 2).append("\n\n");
    ...
    /**
     * Muestra el formulario para buscar ruta con DFS (Pila)
     */
    public void mostrarFormularioBuscarRutaDFSPila() {
        Stage dialog = new Stage();
        dialog.initModality(Modality.APPLICATION_MODAL);
        dialog.initOwner(ownerStage);
        dialog.setTitle("Buscar Ruta DFS (Pila)");
        ...
        Button btnBuscar = new Button("Buscar Ruta DFS (Pila)");
        TextArea txtResultado = new TextArea();
        txtResultado.setEditable(false);
        txtResultado.setPrefSize(400, 200);
        ...
        btnBuscar.setOnAction(e -> {
            try {
                ...
                List<String> ruta = manager.buscarRutaDFSPila(origen, destino);
                
                if (ruta != null) {
                    StringBuilder resultado = new StringBuilder();
                    resultado.append("RUTA DFS (PILA) ENCONTRADA\n");
                    resultado.append("===========================\n");
                    resultado.append("Origen: ").append(origen).append("\n");
                    resultado.append("Destino: ").append(destino).append("\n");
                    resultado.append("Número de escalas: ").append(ruta.size() - 2).append("\n\n");
