...
public class MenuManager {
    ...
    private Button btnBuscarRutaDFSPila;
    ...
    private VBox crearSeccionRutas() {
        ...
        btnBuscarRutaDFS = UIComponentFactory.crearBotonMenu("Búsqueda DFS (Recursivo)", "");
        btnBuscarRutaDFSPila = UIComponentFactory.crearBotonMenu("Búsqueda DFS (Pila)", "");
        
        rutasSection.getChildren().addAll(btnBuscarRuta, btnBuscarRutaBFS, btnBuscarRutaDFS, btnBuscarRutaDFSPila);
        return rutasSection;
    }
    ...
    /**
     * Obtiene el botón de buscar ruta DFS con pila
     */
    public Button getBtnBuscarRutaDFSPila() {
        return btnBuscarRutaDFSPila;
    }
